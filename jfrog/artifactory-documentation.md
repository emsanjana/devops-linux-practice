...
## Step 4: Download JFrog Artifactory
wget https://jfrog.bintray.com/artifactory/jfrog-artifactory-oss-6.9.6.zip

## Step 5: Install unzip (if not already installed)
sudo apt install unzip -y

## Step 6: Unzip Artifactory Package
unzip -o jfrog-artifactory-oss-6.9.6.zip -d /opt/

## Step 7: Navigate to Artifactory Directory
cd /opt/artifactory-oss-6.9.6

## Step 8: Start JFrog Artifactory
./bin/artifactory.sh start

## Step 9: Access Artifactory UI
...
## Step 14: Create a Maven Local Repository

### 14.1 Open Repository Configuration
Navigate: Admin → Repositories → Local → New

### 14.2 Select Package Type
Maven

### 14.3 Configure Maven Repository
...
### 14.5 Verify Repository
Go to Artifacts → You should see maven-local

## Step 15: Prepare Test Files for Generic Repository
...
## Step 16: Upload Test Files via Web UI

### 16.1 Navigate to Artifacts
Click generic-local
